using ecms_v2p1.api.Entities;
using Microsoft.EntityFrameworkCore;

namespace ecms_v2p1.api.Data
{
    public class ecms_v2p1DbContext:DbContext
    {
        public ecms_v2p1DbContext(DbContextOptions<ecms_v2p1DbContext> options):base(options)
        {
